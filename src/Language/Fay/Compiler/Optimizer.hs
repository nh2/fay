...
demo =
  JsApp (JsName (JsNameVar (Qual (ModuleName "Fay$") (Ident "then$uncurried"))))
        [JsApp (JsName (JsNameVar (Qual (ModuleName "Fay$") (Ident "then$uncurried"))))
               [JsApp (JsName (JsNameVar (Qual (ModuleName "Fay$") (Ident "then$uncurried"))))
                      [JsName (JsNameVar (Qual (ModuleName "Main") (Ident "a")))
                      ,JsName (JsNameVar (Qual (ModuleName "Main") (Ident "b")))]
               ,JsName (JsNameVar (Qual (ModuleName "Main") (Ident "c")))]
        ,JsName (JsNameVar (Qual (ModuleName "Main") (Ident "d")))]
